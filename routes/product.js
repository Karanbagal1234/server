...
import { addToCart, createProduct, getProducts, productScan, removeProduct } from "../controller/product.js";
...
router.post("/remove-product", retailerAuth, wrapper( removeProduct));
